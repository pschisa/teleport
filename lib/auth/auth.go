...
// validateMFARegResponseWithToken adds MFA device with keys associated with a user token.
func (a *Server) validateMFARegResponseWithToken(ctx context.Context, regResp *proto.MFARegisterResponse, token types.UserToken, deviceName string) error {
